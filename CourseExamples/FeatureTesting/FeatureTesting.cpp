// FeatureTesting.cpp
// Adapted from Rainer Grimm: https://www.modernescpp.com/index.php/feature-testing-macros/
// based on reference information from cppreference.com https://en.cppreference.com/w/cpp/feature_test
// 
// This will report the values of the C++ feature test macros for your compiler.
// Check the values against those documented at cppreference.com (above link) to determine what features
// your compiler will support.  You may need to specify a project property on Windows or a command-line option to 
// select C++20.
...
// Include the <version> header if your compiler has it
#ifdef __has_include
...
static struct PrintOptions {
    ...
    constexpr static bool sorted_by_value = 1;
...
//    std::cout << "Did not find C++11 or later.  Check project settings or compiler options for the standard level.\n";
//#else
